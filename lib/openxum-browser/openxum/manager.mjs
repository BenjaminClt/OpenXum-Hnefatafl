...
// public methods
  ...
  replay(moves, pause) {
    ...
    moves.split(";").forEach(function (move) {
      if (move !== '') {
        this2._move = this2._that.build_move();
        this2._move.parse(move);
        
        this2._move_list.push(this2._move);
        if (!pause) {
          this2._engine.move(this2._move);
        }
      }
    });
    ...
    if (pause) {
      this._loop = setInterval(function() {
        this2._move = this2._move_list[this2._index];
        this2._engine.move(this2._move);
        this2._gui.draw();
        this2._index++;
        if (this2._index === this2._move_list.length) {
          clearInterval(this2._loop);
          this2._gui.ready(true);
        }
      }, 1000);
    } else {
      this.ready(true);
